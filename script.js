...
function showMeme() {
  ...
  document.getElementById("memeOutput").src = randomMeme;
  document.getElementById("memeOutput").hidden = false;
  document.getElementById("output").hidden = true;
  document.getElementById("riddleAnswerOutput").hidden = true;
}
...
function showJoke() {
  ...
  document.getElementById("output").innerHTML = randomJokeText;
  document.getElementById("memeOutput").hidden = true;
...
function showQuote() {
  ...
  document.getElementById("output").innerHTML = randomQuote.quote + " - " + randomQuote.author;
  document.getElementById("riddleAnswerOutput").hidden = true;
  document.getElementById("output").hidden = false;
  document.getElementById("memeOutput").hidden = true;
...
function showRiddle() {
  ...
  document.getElementById("output").innerHTML = randomRiddle.question;
  document.getElementById("riddleAnswerOutput").innerHTML = randomRiddle.answer;
  document.getElementById("riddleAnswerOutput").hidden = true;
}
...
function revealAnswers() {
  document.getElementById("riddleAnswerOutput").setAttribute("hidden", "false");
  document.getElementById("riddleAnswerOutput").hidden = false;
}
